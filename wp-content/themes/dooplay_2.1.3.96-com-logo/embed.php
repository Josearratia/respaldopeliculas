...
//$driver = $_GET['id'];
$driver = "https://drive.google.com/file/d/0BypABqNqmyIaZHFNQnVrcF8tdWM/view";
...
parse_str($data,$data);
		...
		foreach($sources as $source){
			...
			$sources = preg_replace('@<file>https://(.*)@si','<file>https://$1&apps=yourdomain.com</file>',$sources);
