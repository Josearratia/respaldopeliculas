...
<body <?php body_class(); ?>>
<?php if(is_single()) { global $user_ID; if( $user_ID ) : if( is_user_logged_in() ) : ?>
...
<div id="contenedor">
<?php if($touchicon) { ?><div class="imagem_head_site"><a href="<?php echo esc_url( home_url() ); ?>/"><img src="<?php echo $touchicon;  ?>" alt="<?php bloginfo('name'); ?>" /></a></div><?php } ?>
<?php if(!$logged) dt_login_form(); ?>
