...
$direct		= get_option('dt_redirect_post_links');
...
<html <?php language_attributes(); ?>>
 <head>
  ...
  <link rel='stylesheet' id='fonts-css'  href='https://fonts.googleapis.com/css?family=Source+Sans+Pro%3A400%2C600&#038;ver=<?php echo DOO_VERSION ?>' type='text/css' media='all' />
  <link rel='stylesheet' id='link-single'  href='<?php echo DOO_URI; ?>/assets/css/front.links.css?ver=<?php echo DOO_VERSION ?>' type='text/css' media='all' />
	...
	<div class="links">
		...
		<div class="bb">
			...
			<div class="custom_fields">
				...
				<span class="valor"><img src="<?php echo DOO_GICO, ( $tipo == 'Torrent') ? 'https://utorrent.com' :saca_dominio($url); ?>"> <?php echo ( $tipo == 'Torrent') ? 'Torrent' : saca_dominio($url); ?></span>
			</div>
			<div class="custom_fields">
