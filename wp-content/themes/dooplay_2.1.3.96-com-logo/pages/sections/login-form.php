<form name="loginform" id="loginform" action="<?php echo esc_url( home_url() .'/wp-login.php'); ?>" method="post">
	<fieldset>
		...
		<input type="text" name="log" id="user_login" value="<?php echo isset( $_POST['user_name'] ) ? $_POST['user_name'] : null; ?>" required/ >
	</fieldset>

	<fieldset>
		<label for="pwd"><?php _d('Password'); ?></label>
		<input type="password" name="pwd" id="user_pass" value="<?php echo isset( $_POST['dt_password'] ) ? $_POST['dt_password'] : null; ?>" required />
	</fieldset>
	<fieldset>
