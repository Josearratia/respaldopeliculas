...
<div class="page_user">
	...
	<nav class="user">
		<ul class="idTabs">
			...
			<li><a href="#views"><?php echo (!wp_is_mobile() ) ? __d('Marked as view') : '<i class="icon-eye"></i>'; ?></a></li>
	...
	<div class="content">
		...
		<div class="upge" id="favorites">
			...
			<div id="items_movies">
				<?php dt_list_items($user_id, array('movies','tvshows'), '18', '_dt_list_users', 'favorites'); ?>
			</div>
			<?php if( $list >= 19 ) { ?>
			<div class="paged">
		...
		<div class="upge" id="views">
			...
			<div id="items_views">
				<?php dt_list_items($user_id, array('movies','tvshows'), '18', '_dt_views_users', 'views'); ?>
			</div>
			<?php if( $view >= 19 ) { ?>
			<div class="paged">
