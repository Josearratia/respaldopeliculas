		...
		<article>
			<div class="image">
				<div class="thumbnail animation-2">
					...
					<img src="<?php if($thumb_id) { echo $thumb_url[0]; } else { dt_image_search('dt_backdrop', $post->ID, 'w92'); } ?>" alt="<?php the_title(); ?>" />
					<?php } else { ?>
					<img src="<?php if($thumb_id) { echo $thumb_url[0]; } else { dt_image_search('dt_poster', $post->ID, 'w92'); } ?>" alt="<?php the_title(); ?>" />
					<?php } ?>
