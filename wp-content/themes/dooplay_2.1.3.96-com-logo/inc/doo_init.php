...
if( ! function_exists( 'links_social_single' ) ) {
    ...
    <div class="dt_social_single">
    	...
    	<a data-id="<?php echo $id; ?>" href="javascript: void(0);" onclick="window.open ('https://pinterest.com/pin/create/button/?url=<?php the_permalink() ?>&amp;media=<?php dt_image('dt_backdrop', $id, 'w780'); ?>&amp;description=<?php the_title(); ?>', 'Pinterest', 'toolbar=0, status=0, width=650, height=450');" class="pinterest dt_social">
...
if( ! function_exists( 'doo_breadcrumb' ) ) {
    function doo_breadcrumb($post_id = null, $post_type = null, $post_type_name = null, $class = null ) {
    	if( $post_id AND $post_type AND $post_type_name ) {
    		...
    		echo '<li property="itemListElement" typeof="ListItem">';
    		echo '<a property="item" typeof="WebPage" href="'.get_post_type_archive_link($post_type).'"><span property="name">'.$post_type_name.'</span></a>';
