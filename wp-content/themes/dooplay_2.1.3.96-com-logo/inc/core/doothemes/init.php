...
========================================================
*/
require_once( DOO_DIR . '/inc/core/dbmovies/init.php');
...
if ( is_admin() ) {
	...
	// Includes
	include_once DOO_DIR . '/inc/core/doothemes/framework/options.php';
	include_once DOO_DIR . '/inc/core/doothemes/framework/assets.php';
	include_once DOO_DIR . '/inc/core/doothemes/framework/upload.php';
	include_once DOO_DIR . '/inc/core/doothemes/framework/class.php';

	// framework class
	new Doothemes_famework($options);
}
...
new Doothemes(
	...
	// Main data
	$config = array(
		'remote_api_url' => DOO_SERVER,
		'item_name'		 => DOO_THEME,
		'theme_slug'	 => DOO_THEME_SLUG,
		'version'		 => DOO_VERSION,
		'author'		 => DOO_COM,
		'download_id'	 => DOO_ITEM_ID,
		'renew_url'		 => DOO_SERVER .'/items/'. DOO_THEME_SLUG
	),
