...
// Define Remote API
define('DBMOVIES_version',  '1.0.1');
define('DBMOVIES_Server',	'hhhhttps://dbmovies.org');
define('DBMOVIES_Cdn',		'https://cdn.dbmovies.org/v5/');
//define('DBMOVIES_Api_dbmv', 'https://2rge.dbmovies.org/');
define('DBMOVIES_Api_tmdb', 'https://api.themoviedb.org/3/');
define ('IMDB_API_URL',  get_bloginfo('stylesheet_directory'). '/inc/imdb');
define('DBMOVIES_Api_dbmv',  get_bloginfo('stylesheet_directory'). '/inc/imdb');
...
========================================================
*/
function dt_dbmovies_key_string($length = 6) {
...
function dt_update_imdb_rating() {
	...
	if( (is_user_logged_in()) && ($apikey)){
		$api	= dt_dbmovies_remote( DBMOVIES_Api_dbmv. $apikey .'/'. $imdbid );
		$data	= json_decode($api, TRUE);
		$rating = $data['rating'];
		$votes	= $data['votes'];
