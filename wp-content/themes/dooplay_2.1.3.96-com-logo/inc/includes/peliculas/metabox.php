...
if( ! function_exists( 'dt_metabox_movies_save' ) ) {
	function dt_metabox_movies_save( $post_id ) {
		...
		// Insert String for Movies LINKs
		$stringmeta		= get_post_meta( $post_id, 'dt_string' );
		$stringidtm		= isset( $_POST['idtmdb'] ) ? $_POST['idtmdb'] : null;
		$stringkey		= 'mov'.dt_dbmovies_key_string(6). $stringidtm;
		...
		$posterurl = isset( $_POST['dt_poster'] ) ? 'https://image.tmdb.org/t/p/w342'. $_POST['dt_poster'] : null;
