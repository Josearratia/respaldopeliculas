...
function starstruck_load_scripts() {
	...
	if (is_singular()) {
		wp_enqueue_script('jquery-raty', get_template_directory_uri(). '/assets/js/front.raty.js', '', DOO_VERSION );
		wp_enqueue_script('starstruck-js', get_template_directory_uri(). '/assets/js/front.ratings.js', array('jquery-raty'), DOO_VERSION );
