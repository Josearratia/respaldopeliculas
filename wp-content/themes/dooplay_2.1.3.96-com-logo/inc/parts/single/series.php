...
$manually           = isset( $_GET['manually'] ) ? $_GET['manually'] : null;
if( $manually == 'true') {
	global $user_ID;
	if( $user_ID ) {
...
doo_breadcrumb( get_the_ID(), 'tvshows', __d('TV Shows') );
?>
...
<style>
#dt_contenedor {
    background-image: url(<?php echo rand_images('imagenes', $id, 'original', true, true); ?>);
...
<div class="sheader">
	...
	<div class="data">
		<h1><?php the_title(); ?></h1>
		<div class="extra">
			<?php if($d = $dt_date1) { echo '<span class="date">', $d->format(DOO_TIME), '</span>'; } ?>
...
<div class="single_tabs">
	<div class="user_control"><?php dt_list_button( get_the_ID() ); dt_views_button( get_the_ID() ); ?></div>
...
<div id="info" class="sbox fixidtab">
	...
	<div class="custom_fields">
		...
		<span class="valor"><?php echo $d->format(DOO_TIME); ?></span>
	</div>
	<?php } ?>
