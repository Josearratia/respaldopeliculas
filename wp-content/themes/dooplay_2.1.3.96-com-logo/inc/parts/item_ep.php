...
<article class="item se <?php echo get_post_type(); ?>" id="post-<?php the_id(); ?>">
	...
	<div class="data">
		...
		<div class="flag" style="background-image: url(<?php echo DOO_URI, '/assets/img/flags/',$field['idioma'],'.png'; ?>)"></div>
		<?php $i++; } endif; ?>
		<?php echo $name; ?>
		</h3>
		<span><?php $date = new DateTime($dates); echo $date->format(DOO_TIME); ?></span>
	</div>
</article>
