...
<?php $dates = dt_get_meta("air_date"); ?>
	<a href="<?php the_permalink() ?>">
		<div class="image">
			<img src="<?php if($thumb_id = get_post_thumbnail_id()) { $thumb_url = wp_get_attachment_image_src($thumb_id,'dt_poster_b', true); echo $thumb_url[0]; } else { dt_image('dt_poster', $post->ID, 'w92'); } ?>" alt="<?php the_title(); ?>" />
		</div>
		<div class="data">
				<h3><?php the_title(); ?></h3>
